# Security Group pour les nœuds master Kubernetes
resource "aws_security_group" "kubernetes_master_sg" {
  name_prefix = "${local.cluster_name}-master-"
  ...
  # Communication entre nœuds du cluster
  ingress {
...
# Security Group pour les nœuds worker Kubernetes
...
# Security Group pour les Load Balancers
resource "aws_security_group" "kubernetes_lb_sg" {
